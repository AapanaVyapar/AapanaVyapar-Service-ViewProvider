...
func main() {
	...
	//err = service.Data.DelShopFromShopData(ctx, dataInsert.ShopId)
	//if err != nil {
	//	panic(err)
	//}
	...
	err = service.Data.AddProductImageInProductData(ctx, dataInsert.ShopId, productId1, "https://imageurl.in")
	if err != nil {
		panic(err)
	}
